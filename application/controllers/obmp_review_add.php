...
// Change the css classes to suit your needs    
        ...
        echo form_open('obmp_review/insert/?' . $_SERVER['QUERY_STRING'], $attributes);
        ?>   
        <fieldset>
        ...
        <p>
            ...
            <input id="raccomandi2" name="raccomandi" type="radio" class="" value="2" <?php echo $this->form_validation->set_radio('raccomandi', '2'); ?> />
            <?php echo $this->lang->line('no'); ?> 
            <input id="raccomandi6" name="raccomandi" type="radio" class="" value="10" <?php echo $this->form_validation->set_radio('raccomandi', '10'); ?> /> 
        ...
        <p>
            ...
            $options = array('' => 'Please Select',
                1 => 'Single leisure traveller',
                2 => 'Single corporate travelle',
                3 => 'Young couples',
                4 => 'Mature couples',
    ...
    <fieldset>
        ...
        <div class="row" >
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="large-12   columns">
                            ...
                            Cliente : <?php echo $review->clienti_cogno; ?>  <small>( <?php echo $review->Nazioni_Descrizione; ?> ) </small> <br>
                            Agenzia : <?php echo $review->agenzia_nome; ?> <br>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="large-6 small-6  columns"  >
                ...
                <?php
                echo '<p>' . $this->lang->line('tell_thank_tex') . '</p>';
