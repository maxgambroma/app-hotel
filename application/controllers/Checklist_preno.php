<?php
//  Checklist_preno.php             
class Checklist_preno extends CI_Controller {
...
// 
		...
		$this->form_validation->set_rules('importo', 'lang:importo', 'required|trim');			
		$this->form_validation->set_rules('note', 'lang:note', 'required|trim');			
		$this->form_validation->set_rules('data_check', 'lang:data_check', 'required|trim');			
		$this->form_validation->set_rules('utente_id', 'lang:utente_id', 'required|trim');
...
// 
		...
		$this->form_validation->set_rules('checklist', 'lang:checklist', 'required|trim');			
		$this->form_validation->set_rules('hotel_id', 'lang:hotel_id', 'required|trim');			
		$this->form_validation->set_rules('preno_id', 'lang:preno_id', 'required|trim');			
		$this->form_validation->set_rules('email', 'lang:email', 'required|trim');			
		$this->form_validation->set_rules('email_pms', 'lang:email_pms', 'required|trim');			
		...
		if ($this->form_validation->run() == FALSE) // validation hasn't been passed
		{
                ...
                */
                ...
                $data['rs_checklist_preno'] =   $this->checklist_preno_model->find_by_id($checklist);
		...
		else // passed validation proceed to post success logic
		{
			...
			{
                          redirect('checklist_preno/index/?error=noupdata&'.$_SERVER['QUERY_STRING'] );			
	 ...
	 /**
       ...
       function delete()
       {
        ...
        $checklist = $this->input->post('checklist');
            ...
            redirect('checklist_preno/edit/?error=nodelete&'.$_SERVER['QUERY_STRING'] );	
