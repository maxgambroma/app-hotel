...
<div class="row">
    ...
    <div class="large-6 columns">
        ...
        <div id="Manutenzione" class="reveal-modal" data-reveal aria-labelledby="manutenzioneTitle" aria-hidden="true" role="dialog">
            ...
            echo form_open (  base_url() . 'index.php/apphotel/manutenzioni', $attributes);
            ?>
            <p>
            ...
            <input type="hidden" name="hotel_id" value="<?php echo $camera->hotel_id; ?>" />
...
<!--            <input type="hidden" name="conto_id" value="" />-->
            ...
            <input type="hidden" name="guasto_piano" value="<?php echo $camera->camere_piano; ?>" />
        ...
        <div class="large-12 columns">
            <fieldset> 
                ...
                <ul class="tabs" data-tab>
                    ...
                    <li class="tab-title"><a href="#panel3">Note</a></li>
                    <li class="tab-title"><a href="#panel4">Review</a></li>
                </ul>
                            ...
                            foreach ($guasticax as $rowguacax) {
                                ...
                                <li class="accordion-navigation">
                                    ...
                                    <div id="panel1a<?php echo $rowguacax->guasto_id; ?>" class="content   " >
                                        ...
                                        <?php
// Change the css classes to suit your needs    
                                        $attributes = array('class' => '', 'id' => 'up_man');
                                        echo form_open(base_url() . 'index.php/guasti/mod_manutenzioni', $attributes);
                                        ?>
                                        <p>
                                            <label for="guasto_priorita">guasto_priorita <span class="required">*</span></label>
