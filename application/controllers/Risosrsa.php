...
class Risosrsa extends CI_Controller {
...
// gestore templete
     ...
     */
        ...
        if ($this->input->get('hotel_id')) {
         ...
         $camara_id = $this->input->get('camera_id');
        
        $data['menu'] = $tex;
        $data['hotel_id'] = $hotel_id;
        $data['camara_id'] = $camara_id;

        
        $data['camara'] = $this->camere_model->find_by_id($camera_id); 
        $data['guasticax'] = $this->camere_model->arrivicamara($camera_id, $hotel_id, $today);
