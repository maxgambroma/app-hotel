                    ...
                    <table border="0" cellpadding="1" width="100%" >
                        ...
                        <tbody>
                            <?php foreach ($guasti as $rowgua) { ?>
                                <tr>
                                     <td> <a href="<?php echo base_url() ?>/index.php/guasti/guasto_camera?camera_id=<?php echo $rowgua->camera_id ;?>&hotel_id=<?php echo $rowgua->hotel_id ;?>"><?php echo $rowgua->guasto_data ;?></a></td>
