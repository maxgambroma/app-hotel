<div class="row">
		...
		<img src="coupon_img.gif" align="left" />
                
		<h2>Regaliamo  10 &euro; al giorno! </h2>
		
                <p>Stampa questo Coupon e prenota attraverso il nostro sito <a href="http://www.<?php echo $UD[$hotel_id]; ?>/">www.<?php echo $UD[$hotel_id];?></a></p>
