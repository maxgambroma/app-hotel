...
// --------------------------------------------------------------------
    ...
    /**
     * Elenca i clienti partiti nella data tutti gli hotel
...
`clienti`.clienti_id = $clienti_id
    ...
    public function review_avg($hotel_id) {
        ...
        public function review_bo($conto_id) {

        $sql = "
    SELECT
	usr_web1_3.clienti.clienti_nome,
	usr_web1_3.clienti.clienti_cogno,
	usr_web1_3.clienti.cliente_nato_a,
	usr_web1_3.clienti.cliente_nato_il,
	usr_web1_3.clienti.cliente_nazione,
	usr_web1_3.clienti.cliente_provincia,
	usr_web1_3.clienti.cliente_residenza,
	usr_web1_3.conti.conto_id,
	usr_web1_3.conti.hotel_id,
	usr_web1_3.conti.foglio_id,
	usr_web1_3.clienti.clienti_id,
	usr_web1_3.conti.in_conto,
	usr_web1_3.conti.out_preno,
	usr_web1_3.conti.out_conto,
	usr_web1_3.conti.preno_id,
	usr_web1_3.conti.numero_camera,
	usr_web1_3.conti.camera_id,
	usr_web1_3.conti.tipo_camera,
	usr_web1_3.conti.tipologia_id,
	usr_web1_3.conti.prezzo,
	usr_web1_3.conti.preno_agenzia,
	usr_web1_3.conti.mercato
        FROM
	usr_web1_3.refer_clienti
	INNER JOIN usr_web1_3.conti
	 ON usr_web1_3.refer_clienti.conto_id = usr_web1_3.conti.conto_id
	INNER JOIN usr_web1_3.clienti
	 ON usr_web1_3.refer_clienti.clienti_id = usr_web1_3.clienti.clienti_id
        WHERE
	usr_web1_3.conti.conto_id = $conto_id
            ";
